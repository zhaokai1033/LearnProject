...
public class DefaultBottomView extends View implements IBottomView {
    ...
    public DefaultBottomView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int default_size = UIUtil.dip2px(context, DEFAULT_SIZE);
        LayoutParams params = new LayoutParams(default_size, default_size, Gravity.CENTER);
        setLayoutParams(params);

        circleSpacing = UIUtil.dip2px(context, 4);
