package com.zk.baselibrary.widget.refresh;
...
import com.zk.baselibrary.widget.refresh.core.OnGestureListener;
import com.zk.baselibrary.widget.refresh.core.PullListener;
import com.zk.baselibrary.widget.refresh.processor.AnimProcessor;
import com.zk.baselibrary.widget.refresh.core.IBottomView;
import com.zk.baselibrary.widget.refresh.processor.IDecorator;
import com.zk.baselibrary.widget.refresh.processor.OverScrollDecorator;
import com.zk.baselibrary.widget.refresh.processor.RefreshProcessor;
...
public class RefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
        ...
        if (mHeadView == null) {
            if (!TextUtils.isEmpty(HEADER_CLASS_NAME)) {
                try {
                    ...
                    setRefreshHeader((IHeaderView) ct.newInstance(getContext()));
                } catch (Exception e) {
        ...
        if (mBottomView == null) {
            if (!TextUtils.isEmpty(FOOTER_CLASS_NAME)) {
                try {
                    ...
                    setRefreshBottom((IBottomView) ct.newInstance(getContext()));
                } catch (Exception e) {
     ...
     * 设置头部刷新View
     */
    public void setRefreshHeader(final IHeaderView headerView) {
        if (headerView != null) {
     ...
     * 设置底部View
     */
    public void setRefreshBottom(final IBottomView bottomView) {
        if (bottomView != null) {
    ...
    public void setMaxHeadHeight(float maxHeightDp) {
        this.mMaxHeadHeight = UIUtil.dip2px(getContext(), maxHeightDp);
    }
    ...
    public void setHeaderHeight(float headHeightDp) {
        this.mHeadHeight = UIUtil.dip2px(getContext(), headHeightDp);
    }

    public void setMaxBottomHeight(float maxBottomHeight) {
        mMaxBottomHeight = UIUtil.dip2px(getContext(), maxBottomHeight);
    }
    ...
    public void setBottomHeight(float bottomHeightDp) {
        this.mBottomHeight = UIUtil.dip2px(getContext(), bottomHeightDp);
    }
    ...
    public void setOverScrollHeight(float overScrollHeightDp) {
        this.mOverScrollHeight = UIUtil.dip2px(getContext(), overScrollHeightDp);
    }
